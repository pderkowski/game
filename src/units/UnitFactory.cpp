...
Unit UnitFactory::createPhalanx(const IntRotPoint& coords, const MapModel* model,
...
Unit UnitFactory::createTrireme(const IntRotPoint& coords, const MapModel* model,
    const players::Player* owner)
{
